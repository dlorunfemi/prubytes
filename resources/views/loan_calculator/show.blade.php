            ...
            <table id="" class="table table-bordered table-condensed table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{date_format(date_add(date_create($request->first_payment_date), date_interval_create_from_date_string($period .' '.$request->repayment_cycle. ' s')),'Y-m-d')}}</td>
                        <td id="repayment">
                            @if($request->repayment_cycle=='daily')
    ...
    <div class="box box-info">
        ...
        <div class="panel-body table-responsive no-padding">
            ...
            <table class="table table-bordered table-condensed  table-hover">
                ...
                <tbody>
                    <input type="hidden" name="count" class="form-control" value="{{$period}}">
                    <?php
                        $count = 0;
                        ...
                        for ($i = 1; $i <= $period; $i++) {
                            ...
                            // if ($request->interest_method == 'default_calculation') {
